...
exports.findbyid_led_bf_fn = function (req,result) {
  ...
  var businessLogicHandler = function businessLogic() {
    ...
    var findbyid_led_bo = require('../bo/findbyid_led_bo.js');
    findbyid_led_bo.findbyid_led_bo_fn(req, function(boResult){
      result(boResult);
    });
